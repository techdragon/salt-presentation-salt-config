...
DATABASES = {
    'default': {
        ...
        'USER': 'graphiteuser',
        'PASSWORD': 'zFdwVAizk9jl',
        'HOST': '127.0.0.1',
        'PORT': ""
    }
}
# host set to IP to avoid postgresql acceptable host limits
...
# CARBONLINK_HOSTS = ["127.0.0.1:7102: {# {{ instance1 }} #}", "127.0.0.1:7202:{# {{ instance2 }} #}"]
